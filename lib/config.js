...
import * as RendererClasses from './asset-renderers/all-renderers'
...
const Config = {
    configData: {
        ...
        renderers: {
            ...
            properties: (function() {
                const renderers = {}
                for (const [name, clss] of Object.entries(RendererClasses)) {
        ...
        fallbackRenderer: {
            ...
            enum: ['none'].concat(Object.keys(RendererClasses).sort()),
