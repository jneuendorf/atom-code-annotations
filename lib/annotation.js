...
export default class Annotation {
    ...
    constructor(codeAnnotationManager, editorData, assetData, fallbackRenderer=null) {
        let gutter
        ...
        ({assetManager: this.assetManager, assetDirectory: this.assetDirectory, lineNumber: this.line, name: this.name} = assetData)
        this.element = null
