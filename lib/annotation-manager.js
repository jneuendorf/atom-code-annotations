...
export default class AnnotationManager {
    ...
    static activate(state) {
        ...
        this.subscriptionsByEditor = new Map()
    ...
    static get initializedEditors() {
        return new Set(this.subscriptionsByEditor.keys())
    }
    ...
    // This is used as a callback when editing a DB file.
    ...
    static _initEditor(editor) {
        ...
        this.subscriptionsByEditor.set(editor, subscriptions)
    }
    ...
    static _uninitEditor(editor) {
        if (this.initializedEditors.has(editor)) {
            ...
            this.subscriptionsByEditor.get(editor).dispose()
            this.subscriptionsByEditor.delete(editor)
        }
        else {
            logger.warn(
