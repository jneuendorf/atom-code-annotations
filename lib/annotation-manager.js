...
export default class AnnotationManager {
    ...
    static showContainer(annotations) {
        console.log(CodeAnnotationContainer.getDerivedStateFromProps)
        this.codeAnnotationContainer = ReactDom.render(
            // <CodeAnnotationContainer update={this._rerenderContainer} />,
    ...
    static _init() {
        ...
        // We don't really have to wait for this since the user will most likely
        // be slower clicking on a gutter icon than the rendering.
        this.codeAnnotationContainer = ReactDom.render(
            // <CodeAnnotationContainer update={this._rerenderContainer} />,
            <CodeAnnotationContainer />,
            this.mountPoint
    ...
    static _initEditor(editor) {
        ...
        for (const [lineNumberStr, rawAnnotations] of Object.entries(rawAnnotationsByLine)) {
            ...
            gutterIcon.addEventListener('click', event => {
                // TODO dynamic!
                this.showContainer(rawAnnotations)
            })
